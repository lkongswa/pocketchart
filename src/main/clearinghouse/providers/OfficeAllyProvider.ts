/**
 * Office Ally Clearinghouse Provider — STUB
 *
 * Placeholder for future Office Ally integration. All methods return
...
const NOT_IMPLEMENTED = 'Office Ally integration is coming soon. Please use Claim.MD for now.';

export class OfficeAllyProvider implements ClearinghouseProvider {
